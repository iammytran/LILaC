...
python src/multimodal_document_manager/step3_add_sentences.py --target_data InfoVQA   --mode extract_text
...
# python src/multimodal_document_manager/step3_add_sentences.py --target_data InfoVQA   --mode split_sentences
...
# python src/multimodal_document_manager/step3_add_sentences.py --target_data InfoVQA   --mode add_to_parsed_documents
