...
def analyze_retrieval_misses(
    ...
    with open(input_file, "r", encoding="utf-8") as f_in, open(
        ...
        for line_num, line in enumerate(f_in, 1):
            ...
            qid = data.get("qid", "")
            target_gt_id = f"{get_ground_truth_doc_id(qid)}.jpeg"
            ...
            if target_gt_id not in predicted_doc_ids:
                ...
                f_out.write("=" * 80 + "\n")
                f_out.write(f"{missed_queries}. QID: {qid}\n")
...
if __name__ == "__main__":
    ...
    INPUT_PATH = "/workspace/LILaC/algorithm_results/LILaC/InfoVQA/retrieval/mmembed_0809/mmembed_0809.jsonl"
    OUTPUT_PATH = "debug/missed_top9_queries.txt"

    analyze_retrieval_misses(INPUT_PATH, OUTPUT_PATH, top_k=4)